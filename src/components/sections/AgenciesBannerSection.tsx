...
export function AgenciesBannerSection() {
    return (
        <section id="agencias" className="w-full py-24 bg-secondary text-white relative overflow-hidden">
            ...
            <div className="container px-4 md:px-6 mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                <ScrollReveal animation="slide-in-left" className="md:w-1/2 space-y-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-semibold tracking-tighter uppercase leading-tight">
                ...
                <ScrollReveal animation="slide-in-right" delay={200} className="md:w-1/2 flex justify-center md:justify-end">
                    <Button asChild className="h-16 px-8 bg-primary text-white hover:bg-secondary font-bold uppercase tracking-widest rounded-2xl transition-all shadow-2xl hover:translate-x-1 border-none">
